...
import { ChevronDown, Copy, ExternalLink, FileText, History, Lock, Share, ShieldAlert, Unlock, Upload, X } from 'lucide-react';
...
export function OrderControlHead({
  ...
  return (
    <section className="order-control-head">
      {hasMensajeOperativo && (
        <button className="order-message-icon-action" type="button" onClick={onOpenMensajeOperativo} title="Mensaje operativo" aria-label="Mensaje operativo">
          <Share size={16} />
        </button>
      )}
